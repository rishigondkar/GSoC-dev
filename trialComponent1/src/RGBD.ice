...
module RoboCompRGBD
{
	...
	interface RGBD
	{
		...
		idempotent void getImage (out ColorSeq color, out DepthSeq depth, out PointSeq points, out RoboCompJointMotor::MotorStateMap hState, out RoboCompGenericBase::TBaseState bState) throws HardwareFailedException;
		...
		void getXYZByteStream (out imgType pointStream, out RoboCompJointMotor::MotorStateMap hState, out RoboCompGenericBase::TBaseState bState) throws HardwareFailedException;
